 ...
 * @author rodolfo
 */
class Tokem_CustomDecoratorSelectPermissao extends Zend_Form_Decorator_Abstract{
    ...
    {   
        ...
        $select = '<div class="col-xs-12 col-sm-4"><div class="form-group"><label>'.$label.'</label> <select id="select_permissao" class="form-control" name="select_permissao">'.'<option>Selecione a permissão <option>'.$markup.'</select></div></div>';
